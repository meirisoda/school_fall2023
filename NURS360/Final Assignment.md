...
However, in the future we do have to take into account what the current younger population is. Earlier this year, there was a collaboration between the Red Cross and Snoopy (the dog) and donors were given Snoopy T-shirts with donations. This blew up on social media, specifically TikTok, and there was a significant increase in the number of donations given throughout the United States. Given the current younger population and the primary factor influenc