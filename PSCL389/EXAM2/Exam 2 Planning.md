...
These two systems are always at odds with eachother and it is the balance between the two that will affect the decisions that one makes. Finding and maintaining balance proves to be quite difficult, as our emotions often act as information. 
This is called the "Affect-as-Information" Hypothesis, and it states that affect often serves as an information that affect a person's decision making. When evaluating an object or a situation, the feelings we receive from that become the "objective" information. This is seen in real life instances; when jurors are induced to feel more distress about a defendant's transgressions, they tend to evaluate the defendant to be more guity. This induced distress affects the decision making process instead of focusing on the defendant's actions themselves. This is called local focus, meaning that they tend to hone in on certain details or specifics. It is seen in highly anxious people, and the opposite is seen in low anxiety states. A person who is "happy" or in a low-anxiety state will adopt a more global focus, evaluating objects, people, and stimuli with all possible information and thus making more "rational" decisions. 
In the Failure of Happiness vignette, we watch a promising graduate student fall into addiction and a spiral of unfortunate events. When he was seemingly happy, he would engage in large scale philosophical discussions with the narrator and work together. However we see as time passes on, that once he had fallen to his addiction, his behavior becomes of somebody who had lost his focus. He is no longer able to focus on the larger things in life; unable to return calls, unable to make financially sound decisions and keep track of things outside of the current moment. 
However, we see that when he wants to check himself into rehab, that he had returned to his old self. The narrator states that he got back to being 'the kid who wanted to change the world'. We quickly see that he falls back into his habits, and later ends with the student taking his own life. 
Drugs are substances with extremely high approach positive affect - they are extremely visceral and directly interact with the body's dopamine production. With high approach positive affect, we see that global attention decreases. The focus is no longer global and "broad", but narrows significantly. This is probably what happened as the studnet -- **talk about using drugs.,** 
Drugs also provide high levels of immediate gratification. The body wants the immediate gratification of ursing drugs, which is evidenced by the ratio of activation of brain regions (delayed rewards activate the anterior prefrontal cortex whereas the immediate rewards activate both the medial prefrontal cortex and the striatum), and reinforces behavior. Between the desire for immediate gratification and a delayed reward, giving into the immediate reward let the emotional system win out over the more rational system, which resulted in the student's "irrational" decisions. 
The student was most likely feeling higher levels of happiness while he was on drugs (in the moment, at least) than he did in the beginning of the story, but the decisions he made and the behavior he displayed was significantly different. Emotions of the same valence (the happiness in the beginning vs the end of the student's life) can have very different consequences for attention, cognition and behavior. 
...
This is displayed in the Failure of Happiness vignette. We see a young man with a seemingly bright future, highly motivated and highly disciplined. However, we follow the story and watch him fall victim to finding happiness through not-so-great means. 
We watch his slow descent into addiction and his efforts to stay afloat - a constant reevaluation of his own self and where he is in life/ 
...
The central executive is another system that allows for flexible and controlled processing of information. It updates and replaces old information with new, relevant information, allocates one's attention to a task or goal, and inhibits any dominant or automatic responses thtat might interfere with the present task or goal. 
This action of self-regulation is important in self-preservation. It keeps a person focused on their goals and also provide an accurate representation of goals and goal-relevant information; and by keeping it in one's working memory, it motivates one to keep their efforts to be self-sustaining. 
-- talk about the reduction of working memory and central executive function with using drugs (bring it back to A Failure of Happiness)
