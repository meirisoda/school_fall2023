...
However, our brain still requires further brain structures to aid in decision making and behavior control. These brain structures (referring to the prefrontal cortex) are usually associated with higher-level processes: reasoning abilities and the capacity for 
