...
Neuroscience research shows that there is a correlation between brain activity and behavioral responses/decision making. The brain can be divided into multiple sections, each corresponding to a different point in human evolution - and they all serve different purposes. The brainstem 
