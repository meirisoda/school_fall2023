...
Where on the Earth would we be able to experience this sort of shift in perspective? We have built our cities and land to accommodate us and our stories, and we can build our digital spaces to accommodate us. but what happens when the structures around us no longer are meant for us? Navigating the architecture in NaissancE is extremely difficult and frustrating, as the structures aren't really meant to be explored. Often times you will fall into a vast nothingness, because the game expects for you to be able to cross a gap that is almost impossible. Traversing a world that is somehow so familiar yet hostile very clearly lays the 
